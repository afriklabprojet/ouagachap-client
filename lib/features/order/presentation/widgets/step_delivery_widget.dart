...
/// Données de l'étape livraison transmises au parent.
class DeliveryData {
...
class StepDeliveryWidget extends StatefulWidget {
  ...
  @override
  State<StepDeliveryWidget> createState() => _StepDeliveryWidgetState();
}

class _StepDeliveryWidgetState extends State<StepDeliveryWidget> {
  ...
  void _notifyCoordsReset() {
    widget.onCoordsUpdated(
      DeliveryData(
        ...
        coordsSet: false,
        recipientName: widget.recipientNameController.text,
        recipientPhone: widget.recipientPhoneController.text,
        packageDescription: widget.packageDescriptionController.text,
        packageSize: widget.selectedPackageSize,
      ),
    );
  }
  ...
  Future<void> _openMapPicker() async {
    ...
    if (result != null && mounted) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Adresse de livraison sélectionnée'),
          behavior: SnackBarBehavior.floating,
  ...
  Widget _buildSizeOption(String value, String label, IconData icon) {
    ...
    return Expanded(
      child: GestureDetector(
        onTap: () => widget.onPackageSizeChanged(value),
        child: Container(
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          TextFormField(
            controller: widget.recipientPhoneController,
